...
var bookingOperations = {
    ...
    getDriverDetailsForOne_Way(req, resp) {
        ...
        let fare_1 = fareCalculation.fixedFareBetweenCities(destination),
            driver_1 = new driverDetails('driver1', 'MH-00-00-0000', 'Maruti Swift', fare_1, 'English', origin, destination, departDate);
        listOfDrivers.push(driver_1);

        let fare_2 = fareCalculation.fareBasedOnPerKM(destination, 20),
            driver_2 = new driverDetails('driver2', 'MH-00-00-1010', 'Maruti Swift', fare_2, 'Kannada', origin, destination, departDate);
